...
const Doctors = [
    ...
    {id: 6,
     ...
     tenure: "1984 - 86",
     appearances: 31,
     intFact: "The 6th Doctor's regeneration was actually done without Colin Baker. Sylvester McCoy, the 7th Doctor, wore a wig to portray the scene" ,
    ...
    {id: 7,
     ...
     tenure: "1987 - 96",
     appearances: 42,
     intFact: "The 7th Doctor was the active iteration of the Doctor when the show was initially put on hiatus in 1989, leaving him as the longest-standing incarnation of the Doctor" ,
    ...
    {id: 8,
     ...
     intFact: "In the 1996 movie, the 8th Doctor claims that he is 'half human on his mothers side', however this is often disregarded by fans of the series" ,
     bio: "The 8th Doctor was a romantic, open-hearted, and quietly tragic incarnation of the Doctor. He was a Doctor who bore his emotions closer to the surface than most. He had a poetic soul and a gentle, childlike spirit, often more interested in understanding people than outsmarting them. He felt more like a wandering philosopher than a time-traveling warrior. He believed deeply in hope, second chances, and the idea that kindness could be a guiding principle, not just a luxury. Beneath all that warmth was someone caught between eras—between the idealism of the past and the looming weight of war. You could feel the heartbreak in him, especially as he began to see how fragile his ideals really were in the face of rising darkness and the looming threat of the Daleks. Even when the universe grew cruel, he clung to his belief that people inherently sought to do good. That made his eventual transformation into a harder, war-bound version of himself all the more painful. The Eighth Doctor wasn't just trying to save others—he was trying to hold on to who he was, and the Last Great TIme War would rob him of that… at least for a time."
    },
    {id: 9,
     ...
     intFact: "The War Doctor was written into Doctor Who as Christopher Eccleston declined to appear in the 50th anniversary of the show. Originally the 9th Doctor would have been the one to have fought in the Time War." ,
     bio: "The War Doctor rejects his title of 'The Doctor', as he spent this entire incarnation fighting in 'The Time War', a war which lasted about 400 years accross all of Time and Space. Burdened by guilt, The War Doctor ended the time war by destroying his home, Gallifrey, his people, and the remaining Dalek forces. A terrible choice, but the alternative was to let the Daleks destroy every living thing in the universe. However, in the episode 'The Day of The Doctor', the War Doctor works with the 10th and 11th Doctors to fold Gallifrey into a pocket dimension, effectively saving his people and destroying a majority of the Dalek forces in the process."
    },
    {id: 10,
    ...
    {id: 12,
     ...
     bio: "The 11th Doctor was a youthful yet ancient incarnation of the Doctor, often regarded as  Despite his boyish appearance and quirky energy, the Eleventh Doctor carried the weight of centuries of knowledge and trauma. He was known for his eccentric, alien mannerisms, as well as his rapid-fire speech, his child-like vibrance, and his deep-seated rage, should one be unfortunate enough to get on his bad side. The Eleventh Doctor formed strong bonds with companions Amy Pond, Rory Williams, and River Song, each of whom played crucial roles in his emotional development and in major events like the Pandorica and the war against the Silence. The eleventh Doctor then met Clara Oswald; actually, he met her quite a few times, as she would later disperse herself into the Doctor’s timestream---appearing and dying repeatedly across time and space---to save his life. He faced some of the Doctor's most complex and personal challenges, including the revelation of the Time War’s hidden truths and his own forgotten incarnation—the War Doctor. His final stand took place on the planet Trenzalore, where he defended a town called Christmas for centuries before receiving another Regeneration cycle from the Time Lords and regenerating into the Twelfth Doctor."
    },
    {id: 13,
    ...
    {id: 14,
     ...
     bio: "The 13th Doctor is a bold and compassionate incarnation of the Time Lord known as the Doctor, emerging from a turbulent regeneration following a near-death fall from her TARDIS. With an infectious enthusiasm and a deep-seated belief in the power of hope, she quickly set about making sense of a universe in chaos. Traveling with a newfound 'fam,' composed of Graham O’Brien, Ryan Sinclair, and Yasmin Khan, she brought a fresh sense of warmth and collaboration to her travels. Though she often masked her burdens with boundless energy and curiosity, the Thirteenth Doctor carried the heavy knowledge of her past lives and the responsibilities that come with them. This Doctor faced some of the most existential revelations of her long life, including the truth about the Timeless Child, a hidden origin that shattered everything she believed about herself and Gallifreyan history. Despite the growing weight of these discoveries and escalating threats like the Lone Cyberman and the Master’s genocidal revenge, the Thirteenth Doctor remained steadfast in her values: kindness, cleverness, and non-violence whenever possible. Her era ended in sacrifice and renewal, as she faced the consequences of her choices and passed the torch through regeneration once again—leaving behind a legacy defined by light in the darkest moments and a fierce love for humanity."
    },
    {id: 15,
     ...
     intFact: "The 14th Doctor was the first, and only Doctor to not only reappear with the same face, but also to 'Bi-Generate' when killed. A process more like mitosis, where the 15th Doctor split from the 14th, and the two co-exist." ,
     bio: "The 14th Doctor is a striking return of a familiar face with new fire—a regeneration wrapped in mystery and emotional weight. Bearing the appearance of a former incarnation, this Doctor emerged unexpectedly following the Thirteenth's regeneration, with no clear understanding of why this face had returned. Charismatic, sharp-witted, and driven by a newfound urgency, the Fourteenth Doctor is a man out of time, wrestling with unfinished business, unresolved guilt, and a universe still in flux. Haunted by echoes of the past yet propelled by a fierce determination to protect the future, the Fourteenth Doctor navigates a fragile world with empathy and precision. His reunion with old friend Donna Noble reawakens deep connections and long-buried consequences, forcing him to confront both who he was and who he must become. Though his time is brief, the Fourteenth Doctor stands as a bridge between legacies—an incarnation defined by second chances, hard truths, and the relentless hope that the Doctor always brings."
    },
    {id: 16,
     ...
     tenure: "2023 - 2025",
     appearances: 19,
     intFact: "This iteration of the Doctor is the most emotionally-open iteration of the Doctor",
     bio: "The 15th Doctor bursts onto the scene with unstoppable energy, dazzling charm, and a heart full of joy and fire. This incarnation is bold, stylish, and emotionally open—embracing life's chaos with a grin and a dance step, yet never losing sight of the pain and injustice beneath the surface. With a vibrant personality and razor-sharp wit, the 15th Doctor is as quick to comfort as he is to challenge, always ready to stand up for those who can't stand for themselves. Reinvigorated by the mysteries of the universe and the thrill of new connections, this Doctor approaches each adventure with a sense of wonder and compassion sharpened by centuries of experience. He forges deep bonds with his companions, especially Ruby Sunday, whose own origins prove deeply entwined with cosmic forces beyond understanding. Whether facing ancient evils, impossible paradoxes, or hidden truths, the 15th Doctor moves forward with radiant conviction—a healer, a rebel, and a beacon of hope in an ever-changing universe.",
    },
    {id: 17,
     ...
     intFact: "The Fugitive Doctor is from a lifetime that The Doctor doesn't have any memories of, purposefully sealed away." ,
     bio: "The Fugitive Doctor is a mysterious and formidable incarnation of the Doctor, hidden deep within the Time Lord's forgotten past. First encountered while living in disguise as human tour guide Ruth Clayton, this Doctor shattered established knowledge of the Doctor's timeline when she emerged during a crisis involving the Judoon. Fierce, direct, and utterly unflinching, the Fugitive Doctor operates with tactical precision and moral clarity, often taking a harder stance than her future selves when confronting injustice. Unlike other incarnations, the Fugitive Doctor appears to be a lone agent resisting the manipulations of the Division, a secretive Gallifreyan organization she once served but later rejected. Her existence, long erased from memory, points to a vast and hidden history tied to the origins of the Time Lords themselves. Though little is known about her full story, one thing is clear: she is the Doctor through and through—driven by the same defiant spirit, sense of justice, and refusal to be controlled."
    }
]
